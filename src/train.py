...
def train(
        path="../Data/BroadcastTestSet"):  # used previously as path: "../Data/blocksworld" ##
    ...
    def batched_loss_slow(params, batch_masks, batch_graphs, batch_candidates, batch_energies, f: float):
        ...
        for i in range(batchsize):
            loss_vec[i] = new_prediction_loss(params, batch_masks[i], batch_graphs[i], batch_candidates[i],
                                              batch_energies[i], f)
